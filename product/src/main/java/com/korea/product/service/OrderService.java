...
public class OrderService {
	...
	public List<ProductDTO> save (OrderDTO dto){
		...
		if(option.isPresent()) {
			...
			throw new RuntimeException(dto.getProductName() + "상품을 찾을 수 없다 : ");
		}
		...
		//주문하기
		OrderEntity order = OrderEntity.builder().product(productEntity).productCount(dto.getProductCount()).build();
		//DB에 주문내역 저장하기
